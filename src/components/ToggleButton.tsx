...
const ToggleButton: React.FC<ToggleButtonProps> = ({
  ...
  return (
    <button
      type="button"
      onClick={() => onClick(id)}
      className={`px-4 py-2 rounded-full text-sm transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-spotify-green/50 ${className} ${
        isSelected
