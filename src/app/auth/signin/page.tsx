	...
	switch (error) {
		case 'OAuthCallback':
			return {
				...
				message:
					'There was a problem during the Spotify authentication process.',
				suggestion:
		...
		case 'Callback':
			return {
				...
				message:
					'The authentication process was interrupted or failed to complete.',
				suggestion:
		...
		case 'access_denied':
			return {
				title: 'Access Denied',
				message:
					'You declined to authorize the application or the authorization was cancelled.',
				suggestion:
		...
		case 'Verification':
			return {
				...
				suggestion:
					'This might be a temporary issue. Please try signing in again.',
				retryable: true,
			};
		default:
			return {
			...
			<div className="min-h-screen flex flex-col items-center justify-center bg-spotify-black px-4">
				<div className="max-w-md w-full text-center space-y-6 bg-spotify-dark-gray rounded-lg p-8">
					...
					<div className="bg-spotify-black/50 rounded-md p-4 text-left">
						<h4 className="text-sm font-semibold text-spotify-white mb-2">
							💡 What you can do:
						</h4>
			...
			<div className="text-center space-y-4">
				...
				<div className="max-w-md mx-auto mt-6">
					<div className="bg-spotify-dark-gray rounded-lg p-4 text-sm text-spotify-light-gray">
						...
						<p>
							Make sure pop-ups are enabled and try refreshing the page if
