		...
		>
			<div className="flex flex-col items-center w-full max-w-4xl xl:max-w-6xl py-12">
				...
				<p className="text-xl md:text-2xl text-center mb-12 text-spotify-light-gray max-w-3xl">
					Dive deep into your Spotify listening history. Discover patterns,
					create custom playlists from any time period, and explore your musical
					evolution with powerful analytics and insights.
				</p>
				...
				<p className="text-sm text-spotify-gray mt-8 text-center max-w-2xl">
					This app uses Spotify Web API to access your personal music data. Your
					data is only used to provide insights and is never shared or stored
					permanently.
				</p>
			</div>
		</main>
